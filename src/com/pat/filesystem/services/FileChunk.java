...
public class FileChunk implements org.apache.thrift.TBase<FileChunk, FileChunk._Fields>, java.io.Serializable, Cloneable, Comparable<FileChunk> {
  ...
  private static final org.apache.thrift.protocol.TField REMAINING_BYTES_FIELD_DESC = new org.apache.thrift.protocol.TField("remainingBytes", org.apache.thrift.protocol.TType.I64, (short)2);
  ...
  public long remainingBytes; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    DATA((short)1, "data"),
    REMAINING_BYTES((short)2, "remainingBytes");
  ...
  private static final int __REMAININGBYTES_ISSET_ID = 0;
  ...
  static {
    ...
    tmpMap.put(_Fields.REMAINING_BYTES, new org.apache.thrift.meta_data.FieldMetaData("remainingBytes", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public FileChunk(FileChunk other) {
    ...
    this.remainingBytes = other.remainingBytes;
  }
  ...
  public FileChunk setRemainingBytes(long remainingBytes) {
    this.remainingBytes = remainingBytes;
    setRemainingBytesIsSet(true);
    return this;
  }

  public void unsetRemainingBytes() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __REMAININGBYTES_ISSET_ID);
  }

  /** Returns true if field remainingBytes is set (has been assigned a value) and false otherwise */
  public boolean isSetRemainingBytes() {
    return EncodingUtils.testBit(__isset_bitfield, __REMAININGBYTES_ISSET_ID);
  }

  public void setRemainingBytesIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __REMAININGBYTES_ISSET_ID, value);
  }
  ...
  public boolean equals(FileChunk that) {
    ...
    boolean this_present_remainingBytes = true;
    boolean that_present_remainingBytes = true;
    if (this_present_remainingBytes || that_present_remainingBytes) {
      if (!(this_present_remainingBytes && that_present_remainingBytes))
        return false;
  ...
  public int hashCode() {
    ...
    boolean present_remainingBytes = true;
    list.add(present_remainingBytes);
    if (present_remainingBytes)
      list.add(remainingBytes);
  ...
  public int compareTo(FileChunk other) {
    ...
    lastComparison = Boolean.valueOf(isSetRemainingBytes()).compareTo(other.isSetRemainingBytes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRemainingBytes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.remainingBytes, other.remainingBytes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class FileChunkStandardScheme extends StandardScheme<FileChunk> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // REMAINING_BYTES
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.remainingBytes = iprot.readI64();
              struct.setRemainingBytesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileChunk struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(REMAINING_BYTES_FIELD_DESC);
      oprot.writeI64(struct.remainingBytes);
      oprot.writeFieldEnd();
